...
public class IronScaffolding extends Block implements IWaterLoggable {
    ...
    public IronScaffolding(String name) {
        ...
        this.setDefaultState(this.stateContainer.getBaseState()
                .with(DISTANCE, Integer.valueOf(11))
    ...
    public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
        ...
        if (blockstate.get(DISTANCE) == 11) {
            if (state.get(DISTANCE) == 11) {
    ...
    public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
        return func_220117_a(worldIn, pos) < 11;
    }
    ...
    public static int func_220117_a(IBlockReader p_220117_0_, BlockPos p_220117_1_) {
        ...
        int i = 11;
        if (blockstate.isIn(MVBlocks.IRON_SCAFFOLDING)) {
        ...
        for (Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate1.isIn(MVBlocks.IRON_SCAFFOLDING)) {
    ...
    static {
        ...
        field_220122_e = VoxelShapes.or(IronScaffolding.field_220123_f, field_220121_d, voxelshape6, voxelshape5, voxelshape8, voxelshape7);
    }
