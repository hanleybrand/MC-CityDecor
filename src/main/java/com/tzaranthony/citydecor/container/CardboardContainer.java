...
//
//import com.tzaranthony.modernvanilla.util.MVContainerType;
...
//
//public class CardboardContainer extends Container {
//    private final IInventory container;
//
//    public CardboardContainer(int p_i50065_1_, PlayerInventory p_i50065_2_) {
//        this(p_i50065_1_, p_i50065_2_, new Inventory(27));
//    }
//
//    public CardboardContainer(int p_i50066_1_, PlayerInventory p_i50066_2_, IInventory p_i50066_3_) {
//        super(MVContainerType.CARDBOARD_BOX, p_i50066_1_);
...
//        for (int k = 0; k < 3; ++k) {
//            for (int l = 0; l < 9; ++l) {
//                this.addSlot(new CardboardSlot(p_i50066_3_, l + k * 9, 8 + l * 18, 18 + k * 18));
//            }
//        }
//
